...
const withShortcutWithType = iconSets.map(({ id, fileType, type, iconPath }) => {
  return {
...
const withShortcutWithoutType = iconSets.map(({ id, fileType, type, iconPath }) => {
  return {
...
const withoutShortcutWithType = iconSets.map(({ id, fileType, type, iconPath }) => {
  return {
...
const withoutShortcutWithoutType = iconSets.map(({ id, fileType, type, iconPath }) => {
  return {
