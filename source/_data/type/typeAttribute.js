module.exports = [
  {
    title: 'ICO, PNG ― without type attributes',
    icons: [
  ...
  {
    title: 'ICO, PNG ― with type attributes',
    icons: [
  ...
  {
    title: 'PNG, SVG ― without type attributes',
    icons: [
      { href: '/assets/icons/png/icon-16.png' },
  ...
  {
    title: 'PNG, SVG ― with type attributes',
    icons: [
      { href: '/assets/icons/png/icon-16.png', type: 'image/png' },
  ...
  {
    title: 'ICO, PNG, SVG ― without type attributes',
    icons: [
      { href: '/assets/icons/ico/icon.ico' },
      { href: '/assets/icons/png/icon-16.png' },
      { href: '/assets/icons/svg/icon-16.svg' },
  ...
  {
    title: 'ICO, PNG, SVG ― with type attributes',
    icons: [
      { href: '/assets/icons/ico/icon.ico', type: 'image/vnd.microsoft.icon' },
      { href: '/assets/icons/png/icon-16.png', type: 'image/png' },
      { href: '/assets/icons/svg/icon-16.svg', type: 'image/svg+xml' },
