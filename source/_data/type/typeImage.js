module.exports = [
  ...
  {
    title: 'PNG served as `image`, SVG served as `image`',
    icons: [
      { href: '/assets/icons/type-image/icon-16.png' },
      { href: '/assets/icons/type-image/icon-16.svg' },
    ],
